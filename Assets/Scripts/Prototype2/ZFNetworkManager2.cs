...
{
    public class ZFNetworkManager2 : ZFNetworkManager
    {
        ///<summary>A list containing the network identity of each player</summary>
        public List<NetworkIdentity> playersId = new List<NetworkIdentity>();

        public override void OnServerAddPlayer(NetworkConnection conn){

            base.OnServerAddPlayer(conn);
            playersId.Add(conn.identity);
        }
